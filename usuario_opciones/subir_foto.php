<?php
  include('admin/php/db_cookingshop.php');
...
<div class="container_cont">
  ...
  <form action="index.php?modulo=subirFoto" method="POST" enctype="multipart/form-data">
  ...
  <?php if (!empty($mensaje)){
    echo '<meta http-equiv="refresh" content="0; url=index.php?modulo=perfil&mensaje=
    '.$mensaje.'&sentencia='.$sentencia.'" />';
  }?>

  <a href="index.php?modulo=perfil" class="volver">Volver al perfil</a>
</div>
