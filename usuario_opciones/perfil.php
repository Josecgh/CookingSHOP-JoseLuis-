<?php
include('/xampp/htdocs/cookingShop/admin/php/db_cookingshop.php');
  ...
  <div class="datos">
    ...
    <div class="perfil">
      ...
      <?php if ($row['imagen_perfil']) { ?>
        <img src="usuario_opciones/fotos_perfiles/<?php echo htmlspecialchars($row['imagen_perfil']); ?>" alt="Imagen de perfil">
      <?php } else { ?>
        <i class="fas fa-user-circle"></i>
      <?php } ?>
      
      <!-- Icono de lápiz -->
      <a href="index.php?modulo=subirFoto" class="edit-icon">
    ...
    <div style="text-align: center; margin-top: 20px;">
      <a href="index.php?modulo=cambiarDatos&id=<?php echo $_SESSION['id'] ?>" class="logout-btn">Editar usuario</a>
    </div>
  </div>
</body>
</html>
