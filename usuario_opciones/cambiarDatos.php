<?php 
include_once "/xampp/htdocs/cookingShop/admin/php/db_cookingshop.php";
...
if (isset($_REQUEST['guardar'])) {
    ...
    if ($res) {
        echo '<meta http-equiv="refresh" content="0; url=index.php?modulo=perfil&mensaje=Datos de ' . $nombre . ' editados con éxito&sentencia=success" />';
    } else {
        echo '<meta http-equiv="refresh" content="0; url=index.php?modulo=perfil&mensaje=Los datos de ' . $nombre . ' no han sido editados&sentencia=danger" />';
    }
}
...
<a href="index.php?modulo=perfil" class="volver-enlace" id="boton">
  <img src="admin/assets/imagenes/anterior.png" alt="Volver a mi perfil" id="imagen-boton" width="50px">
</a>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
              <form action="index.php?modulo=cambiarDatos" method="post">
